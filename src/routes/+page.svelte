<script lang="ts">
	...
	const questions =
		"lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptates lorem ipsum dolor sit amet consectetur adipisicing elit.?";
	const options = [
		{ label: "Choice A", isCorrect: false },
		{ label: "Choice B", isCorrect: false },
...
<section class="container max-w-[1124px] bg-orange-100 p-5 mx-5 min-h-[500px]">
	<div class="flex flex-col sm:flex-row h-full">
		<div class="bg-blue-700 sm:w-3/5 lg:w-2/3">
			<Question question={questions} options={options} />
		</div>
